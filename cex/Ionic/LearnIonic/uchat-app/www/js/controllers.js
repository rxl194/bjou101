...
.controller('MainCtrl', ['$scope', 'Loader', '$ionicPlatform', '$cordovaOauth', 'FBFactory', 'UserFactory', 'currentAuth', '$state',
  function ($scope, Loader, $ionicPlatform, $cordovaOauth, FBFactory, UserFactory, currentAuth, $state) {
    $ionicPlatform.ready(function () {
      ...
      $scope.loginWithGoogle = function () {
        ...
        FBFactory.auth().$signInWithPopup("google").then(function(authData) {
...
.controller('FileUploadCtrl', ['$scope', 'Loader', '$ionicPlatform', 'Upload', 'FBFactory',
  function ($scope, Loader, $ionicPlatform, Upload, FBFactory) {
    $ionicPlatform.ready(function () {
      Loader.hide();
